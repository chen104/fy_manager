...
public class _Generator {
	...
	private static String[] excludedTable = { "news_feed_reply", // 暂不实现该功能
			"project_page_view", "share_page_view", "feedback_page_view", "login_log", "sensitive_words",
			"upload_counter", "task_run_log", "message_tip", "friend", "project_like", "share_like", "feedback_like",
			"share_reply_like", "feedback_reply_like", "like_message_log", "account_role", "role_permission" };
	...
	public static void main(String[] args) {
		...
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath() + "/src/main/java/com/jfinal/club/common/model/base";
		...
		gen.setRemovedTableNamePrefixes("fy_base_");
		// 生成
		gen.generate();
	}
}
