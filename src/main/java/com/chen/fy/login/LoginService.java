...
import com.chen.fy.common.AuthCodeService;
import com.chen.fy.model.Account;
import com.chen.fy.model.AuthCode;
...
public class LoginService {
	...
	public Ret retrievePassword(String authCodeId, String newPassword) {
		...
		if (authCode != null && authCode.isValidRetrievePasswordAuthCode()) {
			...
			int result = Db.update("update account set password=?, salt=? where id=? limit 1", newPassword, salt,
					accountId);
			if (result > 0) {
