...
public class PlanController extends BaseController {
	PlanService service = PlanService.me;
	...
	public void findJsonPage() {
		...
		String str = engine.getTemplate("stringTemplet/product/plan/list.jf").renderToString(data);
		ret.set("data", str);
	...
	public void findUpdatePlan() {
		...
		try {
			...
			setAttr("callbackurl", "/fy/admin/biz/product/plan");
